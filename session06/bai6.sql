...
select full_name, position, salary from employees where salary > (select avg(salary) from employees);
...
select full_name, department, salary from employees where salary in (select max(salary) from employees group by department);
 ...
 select full_name, department, hire_date from employees where hire_date in (select min(hire_date) from employees group by department);
