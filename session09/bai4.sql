...
-- Tìm tất cả các đơn hàng (orders) trong bảng orders có ngày đặt hàng (orderDate) nằm trong năm 2003 và trạng thái (status) là Shipped. Trả về mã đơn hàng (orderNumber), ngày đặt hàng (orderDate), và trạng thái đơn hàng (status).
...
-- Tìm tất cả các khách hàng (customers) trong bảng customers có số điện thoại (phone) là 2035552570. Trả về mã khách hàng (customerNumber), tên khách hàng (customerName), và số điện thoại (phone).
